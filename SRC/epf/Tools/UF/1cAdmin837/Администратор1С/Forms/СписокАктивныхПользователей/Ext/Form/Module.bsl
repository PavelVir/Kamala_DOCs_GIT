...
Процедура ОткрытьЖурналРегистрации()
	...
	ЖурналРегистрации = ОткрытьФорму("ВнешняяОбработка.Администратор1С.Форма.ЖурналРегистрации");
...
Процедура ОткрытьЖурналРегистрацииПоПользователю()
	...
	ОткрытьФорму("ВнешняяОбработка.Администратор1С.Форма.ЖурналРегистрации", Новый Структура("Пользователь", ИмяПользователя));
КонецПроцедуры
