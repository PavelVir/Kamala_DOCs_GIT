...
Процедура ПриОткрытии()
	...
	ПолеВводаПериодПриИзменении("");
	 ...
	 //Ситис Вирич П.В.   Начало 2014-11-05
	 УстановитьВариантыНастроек();
	 //Ситис Вирич П.В.   Конец 2014-11-05 
...
Процедура УстановитьВариантыНастроек()
	...
	КП = ЭлементыФормы.ДействияФормы; НоваяКнопка = КП.Кнопки.Вставить(1,"_ВариантыОтчетов", ТипКнопкиКоманднойПанели.Подменю, "Варианты отчетов", );
